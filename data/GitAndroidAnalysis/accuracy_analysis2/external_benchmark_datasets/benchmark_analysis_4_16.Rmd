...
ucp.lm = lm(Real_Effort_Person_Hours ~ UCP, data=ucp_data)
print(summary(ucp.lm)$r.squared)
...
afp.lm = lm(AFP ~ Effort, data=fp_data)
print(summary(afp.lm)$r.squared)

albrecht_data <- read.csv("albrecht.csv")
albrecht.lm = lm(AdjFP ~ Effort, data=albrecht_data)
print(summary(albrecht.lm)$r.squared)

kemerer_data <- read.csv("kemerer.csv")
kemerer.lm = lm(AdjFP ~ EffortMM, data=kemerer_data)
print(summary(kemerer.lm)$r.squared)

miyazaki94_data <- read.csv("miyazaki94.csv")
