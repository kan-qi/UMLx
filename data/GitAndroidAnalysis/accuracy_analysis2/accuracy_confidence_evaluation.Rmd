...
modelData <- selectData("../android_analysis_datasets/android_dataset_6_20_1.csv")
...
#using the entire dataset to train the models
#currentModels = models
#models = currentModels

fitEval = evalFit(models, modelData, c("R2", "eta-squared"))

trainedModels <-modelT
rain(models, modelData)
...
sig_bs_f = sig_bs[which(sig_bs$bonferroni_p_value < 0.05),]
sig_bs_f = sig_bs_f[which(sig_bs_f$metric %in% c("mmre", "pred15", "pred25", "pred50")),]
