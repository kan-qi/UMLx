...
modelData <- selectData("dsets/combined_data_set_4_1.csv")
...
for(i in 3:nCategories){
  print(projectCategories[i, ])
  #categorizedDataset <- selectData("dsets/combined_data_set_4_1.csv", selector=projectCategories[i,])
  categorizedDataset <- selectData(modelData, selector=projectCategories[i,])
...
for(i in 1: length(names(categorizedBenchmarkResults))){
