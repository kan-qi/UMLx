...
print(outputDir)
dataset <- read.csv("dsets/combined_data_set_9_13.csv")
...
dataset_name = 'combined_data_set_9_13.csv'

# test the saveBenchmarkResults function whcih saves BM results as json file in specified output directory
saveBenchmarkResults(benchmarkResults, dataset_name, outputDir)
