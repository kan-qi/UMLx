...
//	private Path graphicPath;
	...
	public ViewGraphic(Context context, AttributeSet attrs) {
		super(context, attrs);
com.mijack.Xlog.logMethodEnter("org.anothermonitor.ViewGraphic.ViewGraphic(android.content.Context,android.util.AttributeSet)",this);//		setLayerType(View.LAYER_TYPE_SOFTWARE, null);
		res = getResources();
...
//		orientation = res.getConfiguration().orientation;
		...
		yTopSeparation = (int) Math.ceil(13*sD);com.mijack.Xlog.logMethodExit("org.anothermonitor.ViewGraphic.ViewGraphic(android.content.Context,android.util.AttributeSet)",this);
	}
...
//	@Override
	...
	protected void onDrawCustomised(Canvas canvas, Thread thread) {
		com.mijack.Xlog.logMethodEnter("void org.anothermonitor.ViewGraphic.onDrawCustomised(android.graphics.Canvas,Thread)",this);if (mSR == null || canvas == null)
			{com.mijack.Xlog.logMethodExit("void org.anothermonitor.ViewGraphic.onDrawCustomised(android.graphics.Canvas,Thread)",this,1);return;}
		...
		if (mThread == null || mThread.isInterrupted())
			{com.mijack.Xlog.logMethodExit("void org.anothermonitor.ViewGraphic.onDrawCustomised(android.graphics.Canvas,Thread)",this,2);return;}
		canvas.drawColor(Color.TRANSPARENT, PorterDuff.Mode.CLEAR);
		if (mThread.isInterrupted())
			{com.mijack.Xlog.logMethodExit("void org.anothermonitor.ViewGraphic.onDrawCustomised(android.graphics.Canvas,Thread)",this,3);return;}
		canvas.drawRect(bgRect, bgPaint);
		
		// Horizontal graphic grid lines
		for (float n=0.1f; n<1.0f; n=n+0.2f) {
			if (mThread.isInterrupted())
				{com.mijack.Xlog.logMethodExit("void org.anothermonitor.ViewGraphic.onDrawCustomised(android.graphics.Canvas,Thread)",this,4);return;}
		...
		for (int n=1; n<=minutes; ++n) {
			...
			if (mThread.isInterrupted())
				{com.mijack.Xlog.logMethodExit("void org.anothermonitor.ViewGraphic.onDrawCustomised(android.graphics.Canvas,Thread)",this,5);return;}
...
//		canvas.drawPath(graphicPath, linesGridPaint);
		...
		// Horizontal edges
		if (mThread.isInterrupted())
			{com.mijack.Xlog.logMethodExit("void org.anothermonitor.ViewGraphic.onDrawCustomised(android.graphics.Canvas,Thread)",this,6);return;}
		canvas.drawLine(xLeft, yTop, xRight, yTop, linesEdgePaint);
		if (mThread.isInterrupted())
			{com.mijack.Xlog.logMethodExit("void org.anothermonitor.ViewGraphic.onDrawCustomised(android.graphics.Canvas,Thread)",this,7);return;}
		canvas.drawLine(xLeft, yBottom, xRight, yBottom, linesEdgePaint);
		
		// Vertical edges
		if (mThread.isInterrupted())
			{com.mijack.Xlog.logMethodExit("void org.anothermonitor.ViewGraphic.onDrawCustomised(android.graphics.Canvas,Thread)",this,8);return;}
		canvas.drawLine(xLeft, yTop, xLeft, yBottom, linesEdgePaint);
		if (mThread.isInterrupted())
			{com.mijack.Xlog.logMethodExit("void org.anothermonitor.ViewGraphic.onDrawCustomised(android.graphics.Canvas,Thread)",this,9);return;}
		canvas.drawLine(xRight, yBottom, xRight, yTop, linesEdgePaint);
		
		// Horizontal legend
		for (int n=0; n<=minutes; ++n) {
			if (mThread.isInterrupted())
				{com.mijack.Xlog.logMethodExit("void org.anothermonitor.ViewGraphic.onDrawCustomised(android.graphics.Canvas,Thread)",this,10);return;}
		...
		if (minutes==0) {
			if (mThread.isInterrupted())
				{com.mijack.Xlog.logMethodExit("void org.anothermonitor.ViewGraphic.onDrawCustomised(android.graphics.Canvas,Thread)",this,11);return;}
		...
		if (mThread.isInterrupted())
			{com.mijack.Xlog.logMethodExit("void org.anothermonitor.ViewGraphic.onDrawCustomised(android.graphics.Canvas,Thread)",this,12);return;}
		canvas.drawText("100%", tempVar, yTop + 5, textPaintLegendV);
		if (mThread.isInterrupted())
			{com.mijack.Xlog.logMethodExit("void org.anothermonitor.ViewGraphic.onDrawCustomised(android.graphics.Canvas,Thread)",this,13);return;}
...
//		canvas.drawText("80%", tempVar, yTop + graphicHeight*0.2f + yLegendSpace, textPaintLegendV);
		if (mThread.isInterrupted())
			{com.mijack.Xlog.logMethodExit("void org.anothermonitor.ViewGraphic.onDrawCustomised(android.graphics.Canvas,Thread)",this,14);return;}
...
//		canvas.drawText("60%", tempVar, yTop + graphicHeight*0.4f + yLegendSpace, textPaintLegendV);
		if (mThread.isInterrupted())
			{com.mijack.Xlog.logMethodExit("void org.anothermonitor.ViewGraphic.onDrawCustomised(android.graphics.Canvas,Thread)",this,15);return;}
...
//		canvas.drawText("40%", tempVar, yTop + graphicHeight*0.6f + yLegendSpace, textPaintLegendV);
		if (mThread.isInterrupted())
			{com.mijack.Xlog.logMethodExit("void org.anothermonitor.ViewGraphic.onDrawCustomised(android.graphics.Canvas,Thread)",this,16);return;}
...
//		canvas.drawText("20%", tempVar, yTop + graphicHeight*0.8f + yLegendSpace, textPaintLegendV);
		if (mThread.isInterrupted())
			{com.mijack.Xlog.logMethodExit("void org.anothermonitor.ViewGraphic.onDrawCustomised(android.graphics.Canvas,Thread)",this,17);return;}
		canvas.drawText("10%", tempVar, yTop + graphicHeight*0.9f + yLegendSpace, textPaintLegendV);
		if (mThread.isInterrupted())
			{com.mijack.Xlog.logMethodExit("void org.anothermonitor.ViewGraphic.onDrawCustomised(android.graphics.Canvas,Thread)",this,18);return;}
		canvas.drawText("0%", tempVar, yBottom + yLegendSpace, textPaintLegendV);
		
		// Read interval, Update interval, Graphic interval width text
		if (mThread.isInterrupted())
			{com.mijack.Xlog.logMethodExit("void org.anothermonitor.ViewGraphic.onDrawCustomised(android.graphics.Canvas,Thread)",this,19);return;}
		...
		if (mThread.isInterrupted())
			{com.mijack.Xlog.logMethodExit("void org.anothermonitor.ViewGraphic.onDrawCustomised(android.graphics.Canvas,Thread)",this,20);return;}
		...
		if (mThread.isInterrupted())
			{com.mijack.Xlog.logMethodExit("void org.anothermonitor.ViewGraphic.onDrawCustomised(android.graphics.Canvas,Thread)",this,21);return;}
		canvas.drawText(graphicIntervaWidthlText + " " + mSR.getIntervalWidth() + " dp", xLeft+15, yTop+5+yTopSeparation*3, textPaintInside);
		
		// Recording text
		if (mSR.isRecording()) {
			if (mThread.isInterrupted())
				{com.mijack.Xlog.logMethodExit("void org.anothermonitor.ViewGraphic.onDrawCustomised(android.graphics.Canvas,Thread)",this,22);return;}
			canvas.drawText(recordingText, xRight-40, yTop+5+yTopSeparation, textPaintRecording);
			if (mThread.isInterrupted())
				{com.mijack.Xlog.logMethodExit("void org.anothermonitor.ViewGraphic.onDrawCustomised(android.graphics.Canvas,Thread)",this,23);return;}
	...
	private void drawLine(List<String> y, Canvas canvas, Paint paint) {
		com.mijack.Xlog.logMethodEnter("void org.anothermonitor.ViewGraphic.drawLine(List<String>,android.graphics.Canvas,android.graphics.Paint)",this);com.mijack.Xlog.logMethodExit("void org.anothermonitor.ViewGraphic.drawLine(List<String>,android.graphics.Canvas,android.graphics.Paint)",this);if(y != null && y.size()>1)
			for(int m=0; m < (y.size()-1) && m < intervalTotalNumber; ++m) {
				if (mThread.isInterrupted())
					return;
				canvas.drawLine(xRight - mSR.getIntervalWidth()*m,
	...
	private void drawLineFloat(List<Float> y, Canvas canvas, Paint paint) {
		com.mijack.Xlog.logMethodEnter("void org.anothermonitor.ViewGraphic.drawLineFloat(List<Float>,android.graphics.Canvas,android.graphics.Paint)",this);com.mijack.Xlog.logMethodExit("void org.anothermonitor.ViewGraphic.drawLineFloat(List<Float>,android.graphics.Canvas,android.graphics.Paint)",this);if(y != null && y.size()>1)
			for(int m=0; m < (y.size()-1) && m < intervalTotalNumber; ++m) {
				if (mThread.isInterrupted())
					return;
				canvas.drawLine(xRight - mSR.getIntervalWidth()*m,
	...
	private void initializeGraphic() {
		com.mijack.Xlog.logMethodEnter("void org.anothermonitor.ViewGraphic.initializeGraphic()",this);yTop = (int) (getHeight()*0.1);
...
//		graphicPath =  new Path();
		...
		graphicInitialised = true;com.mijack.Xlog.logMethodExit("void org.anothermonitor.ViewGraphic.initializeGraphic()",this);
	}
	...
	private Paint getPaint(int color, Paint.Align textAlign, int textSize, boolean antiAlias, float strokeWidth) {
		com.mijack.Xlog.logMethodEnter("android.graphics.Paint org.anothermonitor.ViewGraphic.getPaint(int,Paint.Align,int,boolean,float)",this);Paint p = new Paint();
		p.setColor(color);
		p.setTextSize(textSize);
		p.setTextAlign(textAlign);
		p.setAntiAlias(antiAlias);
		p.setStrokeWidth(strokeWidth);
		{com.mijack.Xlog.logMethodExit("android.graphics.Paint org.anothermonitor.ViewGraphic.getPaint(int,Paint.Align,int,boolean,float)",this,1);return p;}
	}
	...
	void setService(ServiceReader sr) {
		com.mijack.Xlog.logMethodEnter("void org.anothermonitor.ViewGraphic.setService(org.anothermonitor.ServiceReader)",this);mSR = sr;
		...
		threshold = mSR.getThreshold();com.mijack.Xlog.logMethodExit("void org.anothermonitor.ViewGraphic.setService(org.anothermonitor.ServiceReader)",this);
	}
	...
	void setParameters(boolean cpuTotalD, boolean cpuAMD,
		...
		com.mijack.Xlog.logMethodEnter("void org.anothermonitor.ViewGraphic.setParameters(boolean,boolean,boolean,boolean,boolean,boolean,boolean)",this);this.cpuTotalD = cpuTotalD;
		this.cpuAMD = cpuAMD;
		...
		this.thresholdD = thresholdD;com.mijack.Xlog.logMethodExit("void org.anothermonitor.ViewGraphic.setParameters(boolean,boolean,boolean,boolean,boolean,boolean,boolean)",this);
	}
	...
	void setProcessesMode(int processesMode) {
		com.mijack.Xlog.logMethodEnter("void org.anothermonitor.ViewGraphic.setProcessesMode(int)",this);this.processesMode = processesMode;com.mijack.Xlog.logMethodExit("void org.anothermonitor.ViewGraphic.setProcessesMode(int)",this);
	}
	...
	void setGraphicMode(int graphicMode) {
		com.mijack.Xlog.logMethodEnter("void org.anothermonitor.ViewGraphic.setGraphicMode(int)",this);this.graphicMode = graphicMode;com.mijack.Xlog.logMethodExit("void org.anothermonitor.ViewGraphic.setGraphicMode(int)",this);
	}
	...
	void calculateInnerVariables() {
		com.mijack.Xlog.logMethodEnter("void org.anothermonitor.ViewGraphic.calculateInnerVariables()",this);intervalTotalNumber = (int) Math.ceil(graphicWidth/mSR.getIntervalWidth());
		minutes = (int) Math.floor(intervalTotalNumber*mSR.getIntervalRead()/1000/60);
		seconds = (int) Math.floor(intervalTotalNumber*mSR.getIntervalRead()/1000);com.mijack.Xlog.logMethodExit("void org.anothermonitor.ViewGraphic.calculateInnerVariables()",this);
	}
}
