...
public class ActivityProcesses extends Activity {
	...
	private BroadcastReceiver receiverFinish = new BroadcastReceiver() {
		...
		public void onReceive(Context context, Intent intent) {
			com.mijack.Xlog.logMethodEnter("void org.anothermonitor.1.onReceive(android.content.Context,android.content.Intent)",this);finish();com.mijack.Xlog.logMethodExit("void org.anothermonitor.1.onReceive(android.content.Context,android.content.Intent)",this);
		}
	};
	...
	protected void onCreate(Bundle savedInstanceState) {
		com.mijack.Xlog.logMethodEnter("void org.anothermonitor.ActivityProcesses.onCreate(android.os.Bundle)",this);super.onCreate(savedInstanceState);
...
//				mLV.setPadding(0, 0, 0, navigationBarHeight);
			...
			if (runningAppProcesses != null) {
				...
				Collections.sort(mListProcesses, new Comparator<Map<String, Object>>(){
					 public int compare(Map<String, Object> o1, Map<String, Object> o2){
						 com.mijack.Xlog.logMethodEnter("int org.anothermonitor.2.compare(Map<String, Object>,Map<String, Object>)",this);if(o1.get(C.pAppName).equals(o2.get(C.pAppName)))
							 {com.mijack.Xlog.logMethodExit("void org.anothermonitor.ActivityProcesses.onCreate(android.os.Bundle)",this,1);{com.mijack.Xlog.logMethodExit("int org.anothermonitor.2.compare(Map<String, Object>,Map<String, Object>)",this,1);return 0;}}
						 {com.mijack.Xlog.logMethodExit("void org.anothermonitor.ActivityProcesses.onCreate(android.os.Bundle)",this,2);{com.mijack.Xlog.logMethodExit("int org.anothermonitor.2.compare(Map<String, Object>,Map<String, Object>)",this,2);return ((String) o1.get(C.pAppName)).compareTo((String) o2.get(C.pAppName)) < 0 ? -1 : 1;}}
					 }
				});
		...
		if (mListProcesses == null || mListProcesses.isEmpty()) {
			...
			{com.mijack.Xlog.logMethodExit("void org.anothermonitor.ActivityProcesses.onCreate(android.os.Bundle)",this,3);return;}
		}
		...
		mLV.setOnItemClickListener(new OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
				com.mijack.Xlog.logMethodEnter("void org.anothermonitor.3.onItemClick(AdapterView<?>,View,int,long)",this);SimpleAdapterCustomised.Tag tag = (SimpleAdapterCustomised.Tag) view.getTag();
				...
				mSA.notifyDataSetChanged();com.mijack.Xlog.logMethodExit("void org.anothermonitor.3.onItemClick(AdapterView<?>,View,int,long)",this);
			}
		});
		...
		mBOK.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				com.mijack.Xlog.logMethodEnter("void org.anothermonitor.4.onClick(View)",this);if (mListSelected.size() != 0) {
				...
				}com.mijack.Xlog.logMethodExit("void org.anothermonitor.4.onClick(View)",this);
			}
		});
	}
	...
	private Map<String, Object> mapDataForPlacesList(boolean selected, String pAppName, String pid, String pPackage, String pName) {
		com.mijack.Xlog.logMethodEnter("Map<String, Object> org.anothermonitor.ActivityProcesses.mapDataForPlacesList(boolean,String,String,String,String)",this);Map<String, Object> entry = new HashMap<String, Object>();
		entry.put(C.pSelected, selected);
		entry.put(C.pAppName, pAppName);
		entry.put(C.pId, pid);
		entry.put(C.pPackage, pPackage);
		entry.put(C.pName, pName);
		{com.mijack.Xlog.logMethodExit("Map<String, Object> org.anothermonitor.ActivityProcesses.mapDataForPlacesList(boolean,String,String,String,String)",this,1);return entry;}
	}
	...
	public void onSaveInstanceState(Bundle outState)  {
		com.mijack.Xlog.logMethodEnter("void org.anothermonitor.ActivityProcesses.onSaveInstanceState(android.os.Bundle)",this);if (mListProcesses.size() != 0)
			outState.putSerializable(C.listProcesses, (Serializable) mListProcesses);
		if (mListSelected.size() != 0)
			outState.putSerializable(C.listSelected, (Serializable) mListSelected);com.mijack.Xlog.logMethodExit("void org.anothermonitor.ActivityProcesses.onSaveInstanceState(android.os.Bundle)",this);
	}
	...
	class SimpleAdapterCustomised extends SimpleAdapter {
		public SimpleAdapterCustomised(Context context, List<? extends Map<String, ?>> data, int resource, String[] from, int[] to) {
			super(context, data, resource, from, to);com.mijack.Xlog.logMethodEnter("org.anothermonitor.ActivityProcesses$SimpleAdapterCustomised.SimpleAdapterCustomised(android.content.Context,List<? extends Map<String, ?>>,int,[String,[int)",this);com.mijack.Xlog.logMethodExit("org.anothermonitor.ActivityProcesses$SimpleAdapterCustomised.SimpleAdapterCustomised(android.content.Context,List<? extends Map<String, ?>>,int,[String,[int)",this);
		}
		
		@Override
		public View getView(int position, View convertView, ViewGroup parent) {
			com.mijack.Xlog.logMethodEnter("View org.anothermonitor.ActivityProcesses$SimpleAdapterCustomised.getView(int,View,ViewGroup)",this);View view = convertView;
			Tag tag = null;
			if (convertView == null) {
			...
			{com.mijack.Xlog.logMethodExit("View org.anothermonitor.ActivityProcesses$SimpleAdapterCustomised.getView(int,View,ViewGroup)",this,1);return view;}
		}
	...
	@Override
	public void onStart() {
		com.mijack.Xlog.logMethodEnter("void org.anothermonitor.ActivityProcesses.onStart()",this);super.onStart();
		registerReceiver(receiverFinish, new IntentFilter(C.actionFinishActivity));com.mijack.Xlog.logMethodExit("void org.anothermonitor.ActivityProcesses.onStart()",this);
	}
	...
	public void onDestroy() {
		com.mijack.Xlog.logMethodEnter("void org.anothermonitor.ActivityProcesses.onDestroy()",this);super.onDestroy();
		unregisterReceiver(receiverFinish);com.mijack.Xlog.logMethodExit("void org.anothermonitor.ActivityProcesses.onDestroy()",this);
	}
}
