...
# add a legend 
#legend(xrange[1], yrange[2], c("Bayesian", "A-Priori", "Original", "Regression"), cex=1.0, col=colors, pch=plotchar, lty=linetype, title="Estimator")
...
# add a legend 
#legend(xrange[1], yrange[2], c("Bayesian", "A-Priori", "Original", "Regression"), cex=0.8, col=colors, pch=plotchar, lty=linetype, title="Estimator")
...
for (i in 1:nDataSets) { 
	...
	print(sub_data_set)
	print(paste("pair-by-part t test: ", i))
...
png(filename=paste(outputPath,'accuracy_evaluation_legend.png', sep='/'),
		type="cairo",
		units="in", 
		width=2.5*2, 
		height=2.5*2,
