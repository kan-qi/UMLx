...
```{r}
data <- read.csv('/Users/mohit/Development/My Scripts/modelEvaluation_4_20_cleaned_1.csv',stringsAsFactors= T)
summary(data)
```
...
```{r}
raw_data <- read.csv(file = "/Users/mohit/Development/My Scripts/modelEvaluation_4_20_cleaned_1.csv", stringsAsFactors = F)
