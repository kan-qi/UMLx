...
outputDir = "./res/test4" ###don't write to existing folders!!!
print(outputDir)
dataset <- read.csv("dsets/D4.csv")
...
regression_tree_models <- regression_tree_model(modelData = modelData)
#register the list of the size metric based models. 
models = append(models, regression_tree_models)
...
# apply the model evaluation procedure
...
model_names <- c("reg_tree","ucp", "fp", "cosmic", "ksloc")
model_texts <- c("REG_TREE","UCP", "IFPUG", "COSMIC", "KSLOC")
