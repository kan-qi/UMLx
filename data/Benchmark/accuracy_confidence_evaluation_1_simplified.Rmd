...
outputDir = "./res/test1" ###don't write to existing folders!!!
print(outputDir)
dataset <- read.csv("dsets/D1.csv")
...
# model_names <- c("reg_tree","ucp", "fp", "cosmic", "ksloc", "step_lnr", "ensemble_trees")
# model_texts <- c("REG_TREE","UCP", "IFPUG", "COSMIC", "KSLOC", "STEP_LNR", "ENSEMBLE_TREES")
# model_estimator <- c("LSR", "LSR", "LSR", "LSR", "LSR", "LSR", "LSR")
model_names <- c("reg_tree","ucp", "fp", "cosmic", "ksloc", "ensemble_trees")
model_texts <- c("REG_TREE","UCP", "IFPUG", "COSMIC", "KSLOC", "ENSEMBLE_TREES")
