...
PREDdata[4, "PRED"] <- 0.3527273;
PREDdata[3, "PRED"] <- 0.3263636;
ggplot(data = MSEdata, aes(x = NumBins, y = log(MSE))) + geom_point(shape = 1) + geom_line() + ggtitle("MSE vs Number of Bins") + 
  theme_bw()
ggplot(data = MMREdata, aes(x = NumBins, y = MMRE)) + geom_point(shape = 1) + geom_line() + ggtitle("MMRE vs Number of Bins") + 
  theme_bw()
...
meltMergedMMREPREDII$Model <- rep("EXUCP",  nrow(meltMergedMMREPREDII)) 
...
avgPreds_DUCP_UCP_FP <- avgPreds[, c("EUCP", "EXUCP", "DUCP", "MKII", "Pred")]
colnames(avgPreds_DUCP_UCP_FP) <- c("SWT-I", "SWT-II", "SWT-III", "IFPUG", "Pred")
#print(avgPreds)
