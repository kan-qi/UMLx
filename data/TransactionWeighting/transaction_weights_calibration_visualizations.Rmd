...
ggplot(combined, aes(x=TL)) + 
  ...
  annotate("text", x=13.5, y=0.25, label= "Gamma: shape=6.54, rate=1.16; p (KS-param) = 0.20")+
...
ggplot(combined, aes(x=TD)) + 
  ...
  stat_function(fun = dgamma, args = list(shape=3.6492150, rate=0.6985361 )) +
  annotate("text", x=16, y=0.18, label= "Gamma: shape=3.65, rate=0.70; p (KS-param) = 0.84")+
...
ggplot(combined, aes(x=DETs)) + 
  ...
  annotate("text", x=55, y=0.10, label= "Gamma: shape=1.66, rate=0.17; p (KS-param) = 0.39")+
