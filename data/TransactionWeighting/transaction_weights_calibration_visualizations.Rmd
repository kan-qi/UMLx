...
combined <- combineData(transactionFileList)
...
TN Search Results
```{r swti part I} 
TNresults <- performSearch(6, effort, combined, transactionFileList, c())
...
```{r swti part I} 
SWTIresults <- performSearch(6, effort, combined, transactionFileList, c("TL"))
# Plot classification results
...
```{r swti part II}
SWTIresults_II <- performSearch(6, effort, combined, transactionFileList, c("TD"))
# Plot classification results
...
SWTIIresults <- performSearch(6, effort, combined, transactionFileList, c("TL", "TD"))
# Plot classification results
...
SWTIIIresults <- performSearch(6, effort, combined, transactionFileList, c("TL", "TD", "DETs"))
# Plot classification results
