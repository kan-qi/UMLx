...
ggplot(modelData[!(modelData$UseCase_Num==0),], aes(x=UseCase_Num)) + 
  ...
  xlab("Number of Use Cases") + ylab("Number of Projects") + ggtitle("Project Distribution - Use Case")+
...
otherSizeMetricsData=modelData[c("Effort", "COCOMO_Estimate", "Priori_COCOMO_Estimate", "UCP", "FP")]
...
print('average improvement by FP')
print(colMeans(avgPreds[, "FP"] - avgPreds[,!colnames(avgPreds) %in% c("Pred")]))
...
avgPreds_DUCP_UCP_FP <- avgPreds[, c("DUCP", "UCP", "FP", "Pred")]
colnames(avgPreds_DUCP_UCP_FP) <- c("SWT-3D", "UCP", "FP", "Pred")
#print(avgPreds)
