...
// should directly analysis the inter-component control flow on top of the soot-cfg.
    function identifyUseCasesfromCFG(sootCallGraph, dicMethodClass, dicResponseMethodUnits, dicMethodUnits, callGraph, dicComponents, dicClassComponent, ModelOutputDir, ModelAccessDir, domainElementsByID){
		...
		function establishHyperControlFlow(dicComponents, dicClassComponent, dicMethodClass, dicResponseMethodUnits, dicMethods, callGraph, outputDir){
        		var edges = [];
        		var nodes = [];
        		...
        		function expandMethod(methodUnit, callGraph, dicMethods, expandedMethods){
                     ...
                     */
                                    	function findCallsForMethod(methodUnit, sootCallGraph, dicMethods){
                                    		var calledMethods = callGraph[methodUnit.signature];
                                    		for(var i in calledMethods){
                                    			var calledMethod = calledMethods[i];
                                    		    calls.push({action:calledMethod, methodUnit:dicMethods[calledMethod]});
                                    		}
        ...
        var cfgGraph = establishHyperControlFlow(dicComponents, dicClassComponent, dicMethodClass, dicResponseMethodUnits, dicMethodUnits, callGraph, ModelOutputDir);
