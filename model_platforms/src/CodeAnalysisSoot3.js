...
//				console.log(dependency["uuid"]);
		...
		for(var k in androidAnalysisResults.compositionGraph){
			var attrDependency = androidAnalysisResults.compositionGraph[k];
...
//				console.log(dependency["uuid"]);
				...
				for(var k in returnDependencies){
					...
					if(methodUnit){
					var startNode = nodeReturnByID[classUnit.name+":"+returnDependency];
					if(!startNode){
						startNode = {
						...
						nodeReturnByID[classUnit.name+":"+returnDependency] = startNode;
					}
					...
					nodeReturnByID[UUID] = endNode;
					}

					edgesReturn.push({start: startNode, end: endNode});
					
					var compositeClassUnit = dicCompositeClassUnits[dicClassComposite[classUnit.UUID]];
					var startNodeComposite = nodesReturnCompositeByID[compositeClassUnit.UUID];
					if(!startNodeComposite){
						startNodeComposite = {
							name: methodUnit.name +":returnDependency",
							UUID: methodUnit.UUID,
						...
						nodesReturnCompositeByID[compositeClassUnit.UUID] = startNodeComposite;
					}
					...
					if(!endNodeComposite){
						...
						nodesReturnCompositeByID[targetCompositeClassUnit.UUID] = endNodeComposite;
					}
					
					edgesReturnComposite.push({start: startNodeComposite, end: endNodeComposite});
				...
				for(var k in paramDependencies){
					...
					if(methodUnit){
					var startNode = nodesParamByID[classUnit.name+":"+k];
					if(!startNode){
						startNode = {
						...
						nodesParamByID[classUnit.name+":"+k] = startNode;
					}
					...
					nodesParamByID[UUID] = endNode;
					}
					
					edgesParam.push({start: startNode, end: endNode});
					
					
					var startNodeComposite = nodesParamCompositeByID[compositeClassUnit.UUID];
					if(!startNodeComposite){
						startNodeComposite = {
							name: methodUnit.name +":paramDependency",
							UUID: methodUnit.UUID,
						...
						nodesParamCompositeByID[compositeClassUnit.UUID] = startNodeComposite;
					}
					...
					if(!endNodeComposite){
						...
						nodesParamCompositeByID[targetCompositeClassUnit.UUID] = endNodeComposite;
					}
				...
				for(var k in localDependencies){
					...
					if(methodUnit){
					var startNode = nodesLocalByID[classUnit.name+":"+k];
					if(!startNode){
						startNode = {
						...
						nodesLocalByID[classUnit.name+":"+k] = startNode;
					}
					...
					nodesLocalByID[UUID] = endNode;
					}
					

					edgesLocal.push({start: startNode, end: endNode});
					
					var startNodeComposite = nodesLocalCompositeByID[compositeClassUnit.UUID];
					if(!startNodeComposite){
						startNodeComposite = {
							name: methodUnit.name +":localDependency",
							UUID: methodUnit.UUID,
						...
						nodesLocalCompositeByID[compositeClassUnit.UUID] = startNodeComposite;
					}
					...
					if(!endNodeComposite){
						...
						nodesLocalCompositeByID[targetCompositeClassUnit.UUID] = endNodeComposite;
					}
