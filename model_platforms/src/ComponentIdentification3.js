				...
				for (var key2 in connectors) {
					if(connectors[key1][key2] == 0){
						...
						if(type === 1){
							...
							var log_freq_1 = Math.log(classes.length/referencingClasses[parse(key1)].length);
							var log_freq_2 = Math.log(classes.length/referencingClasses[parse(key2)].length);
							//relative weight
							if(key1 === key2){
