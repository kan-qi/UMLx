/**
 * This module will directly generate sequence and class diagrams from source code. The actual parsing work is done within UML Parser written in Java.
 */
(function() {
	var fs = require('fs');
...
//				Attachment: XMIClass
	...
	function extractUserSystermInteractionModel(filePath, callbackfunc) {
		...
		// use the source code to construct the diagrams in xml format, so that we can still use the existing parser to extract the information.
