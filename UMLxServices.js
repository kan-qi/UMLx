...
app.get('/apiInfo',function(req,res){
	var apiId = req.query['ip'];
	var apiDate = req.query['date'];
	var apiRequestTime = req.query['request_time']

	umlModelInfoManager.queryAPIRequest(apiId, apiDate,apiRequestTime, function (apiInfo) {

		console.log(apiInfo);
		res.render('apiInfo',{api_data:apiInfo});
...
app.get('/pageInfo',function(req,res){
	...
	var pageDate = req.query['Date'];
	umlModelInfoManager.queryPageReview(pageId, pageDate, function (pageInfo) {

		console.log(pageInfo);
		res.render('pageInfo',{page_data:pageInfo});
	});
});
