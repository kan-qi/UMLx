...
function autoFillEstimatorName(){
    var mySource = [
        { label: 'EUCP', value: 'eucp_lm' },
        { label: 'EXUCP', value: 'exucp_lm' },
        { label: 'DUCP', value: 'ducp_lm'}
        ];
    $('#model').autocomplete({
        source: mySource,
...
$(document).ready(function () {
    console.log("lhhtest==========================");
    $(document).on('keydown', '#model', autoFillEstimatorName)
