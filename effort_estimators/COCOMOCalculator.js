...
//		(cocomoData.EM.PROJ.SCED - COCOMO.EM.PROJ.SCED.N);
	...
	module.exports = {
		...
		loadCOCOMOData: function(ModelDataFilePath, callbackfunc){
			...
			fileManagerUtil.loadCSVFile(ModelDataFilePath, true, function(data){
				var modelDataArray = {};
				for(var i in data){
					...
					modelData['PROJ'] = dataElement['PROJ'];
				}
...
//				loadModelEmpirics(modelLoad, modelInfo, modelIndex);
				...
				cocomoData["PROJ"]	= modelLoad['PROJ'];
//				console.log(modelLoad);
				...
				cocomoDataList.push(cocomoData);
				}
