...
var analyseAndroidApks = function analyseAndroidApks(apkFileName, reportDir){
	...
	//return AndroidLogUtil.generateAndroidAnalysis(apkFileName);
	/* dummy android apk analysis due to that gator command cannot run on local machine with MAC OS*/
	return new Promise((resolve, reject) => {
		var project = {
		    "reportDir": "/Users/diaozhuoran/desktop/DR2/UMLxKqi/UMLx/data/GitAndroidAnalysis/batch_analysis",
		    "repoDir": "/Users/diaozhuoran/desktop/DR2/UMLxKqi/UMLx/data/GitAndroidAnalysis/batch_analysis",
		    "projectList": [
		        {
...
var analyseAndroidProject = function analyseAndroidProject(project, reportDir){
