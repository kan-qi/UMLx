...
projectHist1 <- ggplot(data, aes(x=Real_Effort))+geom_histogram(binwidth=200, colour="white", fill="gray55")+xlab("Effort (person-hours)")+ylab("Count")
projectHist2 <- ggplot(data, aes(x=KSLOC))+geom_histogram(binwidth=1, colour="white", fill="gray55")+xlab("KSLOC")+ylab("Count")
projectHist3 <- ggplot(data, aes(x=Use_Case_Num))+geom_histogram(binwidth=2, colour="white", fill="gray55")+xlab("Use Case Num")+ylab("Count")
projectBar <- ggplot(data, aes(x=Application_Type))+geom_bar(colour="white", fill="gray55")+xlab("Application Type")+ylab("Count")+ scale_x_discrete(label=abbreviate)
...
UCPHist1 <- ggplot(data, aes(x=UAW))+geom_histogram(binwidth=1.5, colour="white", fill="gray55")+xlab("UAW")+ylab("Count")
UCPHist2 <- ggplot(data, aes(x=UDUCW))+geom_histogram(binwidth=30, colour="white", fill="gray55")+xlab("UDUCW")+ylab("Count")
UCPHist3 <- ggplot(data, aes(x=DUCP))+geom_histogram(binwidth=45, colour="white", fill="gray55")+xlab("DUCP")+ylab("Count")
UCPHist4 <- ggplot(data, aes(x=UUCW))+geom_histogram(binwidth=20, colour="white", fill="gray55")+xlab("UUCW")+ylab("Count")
UCPHist5 <- ggplot(data, aes(x=UCP))+geom_histogram(binwidth=30, colour="white", fill="gray55")+xlab("UCP")+ylab("Count")
UCPHist6 <- ggplot(data, aes(x=TCF))+geom_histogram(binwidth=0.02, colour="white", fill="gray55")+xlab("TCF")+ylab("Count")
UCPHist7 <- ggplot(data, aes(x=EF))+geom_histogram(binwidth=0.02, colour="white", fill="gray55")+xlab("EF")+ylab("Count")
