...
//  private ExecutorService executor = Executors.newFixedThreadPool(1);
  ...
  private static MethodsWriter theInstance;

  // time analysis begins
  private long startTime;

  private MethodsWriter() throws Exception {
	  debugFileName = Configs.outputDir+"/methods.txt";
  ...
  public static synchronized MethodsWriter v() {
    if (theInstance == null) {
      try {
        theInstance = new MethodsWriter();
      } catch (Exception e) {
