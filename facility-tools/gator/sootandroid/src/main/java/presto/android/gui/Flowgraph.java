...
//      Logger.verb(this.getClass().getSimpleName(), "{SetMenuItemId} " + s + " @ " + currentMethod);
    ...
    if (titleSpecifier != null) {
      NOpNode setText = new NSetTextOpNode(titleSpecifier, menuItem, NSetTextOpNode.Type.TITLE, callSite);
  ...
  public NOpNode createMenuItemSetTitleOpNode(Stmt s) {
    ...
    NOpNode setText = new NSetTextOpNode(titleNode, receiverNode, NSetTextOpNode.Type.TITLE, callSite);
  ...
  public NOpNode createTextViewSetTextOpNode(Stmt s) {
    if (!Configs.enableSetTextAnalysis)
      return null;
    InvokeExpr ie = s.getInvokeExpr();
    SootMethod callee = ie.getMethod();
    String subSig = callee.getSubSignature();
