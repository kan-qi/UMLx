...
public class ListenerSpecification {
  ...
  public boolean isListenerType(SootClass c) {
    if (hier.getSupertypes(c) == null) {
        ...
        Logger.trace(this.getClass().getSimpleName(), "[WARNING]: attempt to check if " + c + " is listener which " +
  ...
  void readFromSpecificationFile(String fn) {
    ...
    try {
      ...
      Logger.trace(this.getClass().getSimpleName(), "--- reading " + fn + "\n");
...
//      Logger.verb(this.getClass().getSimpleName(), "GUI: " + type);
      if (guiClass.isPhantom()) {
//        Logger.verb(this.getClass().getSimpleName(), "  !!! Phantom !!!");
        continue;
      }
