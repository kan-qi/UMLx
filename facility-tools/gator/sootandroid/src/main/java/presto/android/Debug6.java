...
//  private ExecutorService executor = Executors.newFixedThreadPool(1);
  ...
  private static Debug6 theInstance;

  // time analysis begins
  private long startTime;

  private Debug6() throws Exception {
    debugFileName = Configs.outputDir+"/test6.json";
  ...
  public static synchronized Debug6 v() {
    if (theInstance == null) {
      try {
        theInstance = new Debug6();
      } catch (Exception e) {
