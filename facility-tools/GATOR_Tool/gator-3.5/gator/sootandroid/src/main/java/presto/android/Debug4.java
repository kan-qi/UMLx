...
//  private ExecutorService executor = Executors.newFixedThreadPool(1);
  ...
  private static Debug4 theInstance;

  // time analysis begins
  private long startTime;

  private Debug4() throws Exception {
    debugFileName = "/mnt/h/ResearchSpace/ResearchProjects/UMLx/facility-tools/GATOR_Tool/gator-3.5/output/android-analysis-output.json";
  ...
  public static synchronized Debug4 v() {
    if (theInstance == null) {
      try {
        theInstance = new Debug4();
      } catch (Exception e) {
