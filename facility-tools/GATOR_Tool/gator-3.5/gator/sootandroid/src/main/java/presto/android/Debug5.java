...
//  private ExecutorService executor = Executors.newFixedThreadPool(1);
  ...
  private static Debug5 theInstance;

  // time analysis begins
  private long startTime;

  private Debug5() throws Exception {
    debugFileName = "/mnt/h/ResearchSpace/ResearchProjects/UMLx/facility-tools/GATOR_Tool/gator-3.5/output/callgraph.json";
  ...
  public static synchronized Debug5 v() {
    if (theInstance == null) {
      try {
        theInstance = new Debug5();
      } catch (Exception e) {
