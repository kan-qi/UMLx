...
//  private ExecutorService executor = Executors.newFixedThreadPool(1);
  ...
  private static Debug3 theInstance;

  // time analysis begins
  private long startTime;

  private Debug3() throws Exception {
    debugFileName = "/mnt/h/ResearchSpace/ResearchProjects/UMLx/facility-tools/GATOR_Tool/gator-3.5/output/commands.txt";
  ...
  public static synchronized Debug3 v() {
    if (theInstance == null) {
      try {
        theInstance = new Debug3();
      } catch (Exception e) {
