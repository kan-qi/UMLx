...
//  private ExecutorService executor = Executors.newFixedThreadPool(1);
  ...
  private static DebugOutput theInstance;

  // time analysis begins
  private long startTime;

  private DebugOutput() throws Exception {
	  debugFileName = Configs.outputDir+"/debug_info.txt";
  ...
  public static synchronized DebugOutput v() {
    if (theInstance == null) {
      try {
        theInstance = new DebugOutput();
      } catch (Exception e) {
