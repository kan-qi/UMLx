...
//  private ExecutorService executor = Executors.newFixedThreadPool(1);
  ...
  private static CallGraphWriter theInstance;

  // time analysis begins
  private long startTime;

  private CallGraphWriter() throws Exception {
  ...
  public static synchronized CallGraphWriter v() {
    if (theInstance == null) {
      try {
        theInstance = new CallGraphWriter();
      } catch (Exception e) {
