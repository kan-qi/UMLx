...
//  private ExecutorService executor = Executors.newFixedThreadPool(1);
  ...
  private static AnalysisResultsWriter theInstance;

  // time analysis begins
  private long startTime;

  private AnalysisResultsWriter() throws Exception {
//    debugFileName = "/mnt/h/ResearchSpace/ResearchProjects/UMLx/facility-tools/gator/output/android-analysis-output.json";
  ...
  public static synchronized AnalysisResultsWriter v() {
    if (theInstance == null) {
      try {
        theInstance = new AnalysisResultsWriter();
      } catch (Exception e) {
