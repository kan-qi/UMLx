(function() {
	...
	var repoAnalyzer = require('./analyzers/RepoAnalyzers.js');
	var projectAnalyzer = require('./analyzers/ProjectAnalyzer.js');
	var useCaseAnalyzer = require('./analyzers/UseCaseAnalyzer.js');
	
	var analyzers = [repoAnalyzer, projectAnalyzer, useCaseAnalyzer];
